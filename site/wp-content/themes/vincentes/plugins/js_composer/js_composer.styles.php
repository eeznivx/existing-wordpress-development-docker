...
if ( !function_exists( 'vincentes_vc_get_css' ) ) {
	add_filter( 'vincentes_filter_get_css', 'vincentes_vc_get_css', 10, 4 );
	function vincentes_vc_get_css($css, $colors, $fonts, $scheme='') {
...
/* Progress bar */
.vc_progress_bar.vc_progress_bar_narrow.vc_progress-bar-color-green .vc_single_bar {
	background-color: {$colors['text_link_02']};
}
.vc_progress_bar.vc_progress_bar_narrow.vc_progress-bar-color-green .vc_single_bar .vc_bar {
	background-color: {$colors['text_link']};
}
...
/* Tabs 2*/
.vc_tta.vc_general.vc_tta-controls-align-right .vc_tta-panels-container .vc_tta-panel-body {
    color: {$colors['text_dark']} !important;
}
.vc_tta.vc_tta-style-classic.vc_tta-controls-align-right .vc_tta-tabs-list .vc_tta-tab > a {
    color: {$colors['text_link2']} !important;
}
.vc_tta.vc_tta-style-classic.vc_tta-controls-align-right .vc_tta-tabs-list .vc_tta-tab.vc_active > a,
.vc_tta.vc_tta-style-classic.vc_tta-controls-align-right .vc_tta-tabs-list .vc_tta-tab > a:hover {
    color: {$colors['text_hover2']} !important;
}
body.wpb-js-composer .vc_row .vc_tta.vc_general.vc_tta-controls-align-right .vc_tta-tab:last-child:after,
.vc_tta.vc_tta-style-classic.vc_tta-controls-align-right .vc_tta-tabs-list .vc_tta-tab > a:after {
