...
if (!function_exists('vincentes_trx_addons_get_css')) {
	add_filter('vincentes_filter_get_css', 'vincentes_trx_addons_get_css', 10, 4);
	function vincentes_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
