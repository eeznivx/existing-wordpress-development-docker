...
if ( !function_exists( 'vincentes_tribe_events_get_css' ) ) {
	add_filter( 'vincentes_filter_get_css', 'vincentes_tribe_events_get_css', 10, 4 );
	function vincentes_tribe_events_get_css($css, $colors, $fonts, $scheme='') {
