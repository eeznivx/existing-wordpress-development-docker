...
if ( !function_exists( 'vincentes_woocommerce_get_css' ) ) {
	add_filter( 'vincentes_filter_get_css', 'vincentes_woocommerce_get_css', 10, 4 );
	function vincentes_woocommerce_get_css($css, $colors, $fonts, $scheme='') {
...
/* Buttons */
.vincentes_shop_mode_buttons a {
	color: {$colors['text_dark']};
}
.vincentes_shop_mode_buttons a:hover {
	color: {$colors['text_link']};
}
